...
const analyzeImage = async () => {
  ...
  try {
    ...
    // Auto-fill food type if AI detected it
...
const handleSubmit = async () => {
  ...
  try {
    ...
    const response = await api.post("/api/donations", formDataSubmit, {
      headers: { "Content-Type": "multipart/form-data" },
    });
...
<div className="space-y-4">
          ...
          <div className="flex gap-3">
            <Button variant="outline" onClick={() => { setImage(null); setImagePreview(null); }} className="flex-1">
              Remove Photo
            </Button>
